...
class App{
    constructor(){
        ...
        document.body.appendChild(this.canvas); //append the element at the parent's end
        this.ctx = this.canvas.getContext('2d');

        this.pixelRatio = (window.devicePixelRatio > 1) ? 2 : 1; // if (window.devicePixelRatio > 1) is true, result is 2, else is 1

        this.totalParticles = 20;
        this.particles = [];
        this.maxRadius = 900; // radius = 반지름
        this.minRadius = 400;
